  ...
  sessions: [
    {
      ...
      exercises: [
        ...
        { exerciseId: "mon-cable-lateral-raises", name: "Cable Lateral Raises", targetWeight: 9, targetReps: [12, 12, 12] },
        {
        ...
        { exerciseId: "mon-machine-seated-row", name: "Machine Seated Row", targetWeight: 109, targetReps: [8, 8, 8] },
        {
    ...
    },
    {
      ...
      exercises: [
        { exerciseId: "tue-leg-press", name: "Leg Press", targetWeight: 145, targetReps: [10, 10, 10] },
        { exerciseId: "tue-leg-press-calves", name: "Leg Press Calves", targetWeight: 106.6, targetReps: [14, 14, 14, 20] },
        ...
        { exerciseId: "tue-leg-curl", name: "Leg Curl", targetWeight: 63, targetReps: [12, 12, 12] },
        { exerciseId: "tue-leg-extension", name: "Leg Extension", targetWeight: 75, targetReps: [10, 10, 10] },
      ],
    },
    {
      day: "wednesday",
      ...
      exercises: [
        ...
        { exerciseId: "wed-lat-pull", name: "Lat Pull", targetWeight: 65, targetReps: [12, 12, 12], notes: "Micro-increase" },
        {
        ...
        { exerciseId: "wed-hammer-curl", name: "Hammer Curl", targetWeight: 14, targetReps: [8, 8, 8] },
        { exerciseId: "wed-cable-bicep-curl", name: "Cable Bicep Curl", targetWeight: 47.5, targetReps: [12, 12, 12] },
      ],
    },
    {
      day: "friday",
      ...
      exercises: [
        ...
        { exerciseId: "fri-leg-press", name: "Leg Press", targetWeight: 152.1, targetReps: [8, 8, 8] },
        { exerciseId: "fri-machine-seated-row", name: "Machine Seated Row", targetWeight: 109, targetReps: [10, 10, 10] },
        { exerciseId: "fri-seated-shoulder-press", name: "Seated Shoulder Press", targetWeight: 16, targetReps: [10, 10, 10] },
        { exerciseId: "fri-cable-bicep-curl", name: "Cable Bicep Curl", targetWeight: 52, targetReps: [10, 10, 10] },
        {
